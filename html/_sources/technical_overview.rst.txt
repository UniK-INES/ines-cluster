...
The Homematic module is used to power the cluster. Additionally we use it when you are not able to create a direct route into the cluster.
...
.. note:: The numeration starts with 01 for every bar.
